...
<div class="container">
    ...
    <form action="{{ url('/customers' )}}" method="get">
        <div class="input-group mb-3 col-md-6">
            <input type="text" class="form-control" placeholder="キーワードを入力" name="search" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{$request->search}}">
        ...
        <div class="collapse col-md-6" id="collapseExample">
            <div class="card card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="min_age" class="form-control" value="{{old('min_age', $request->min_age) ?? 0}}">
                    <div class="input-group-prepend">
                        <span class="input-group-text">〜</span>
                    </div>
                    <input type="text" name="max_age" class="form-control" value="{{old('max_age', $request->max_age) ?? 120}}">
                </div>
                <button class="btn btn-outline-primary" type="submit" id="button-addon2">検索</button>
            </div>
        </div>
